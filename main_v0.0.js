...
var actualPaletizer = 0,
  statePaletizer = 0;
var Paletizer2, ctPaletizer2 = 0,
  speedTempPaletizer2 = 0,
  secPaletizer2 = 0,
...
function senderData2() {
  clientHttp.methods.postMethod(publishConfig2, function(data, response) {
    // parsed response body as js object
    console.log(data.toString());
  });
}
